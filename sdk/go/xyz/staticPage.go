...
func NewStaticPage(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("miniflux:index:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *Service) ToStaticPageOutput() StaticPageOutput {
	return i.ToStaticPageOutputWithContext(context.Background())
}

func (i *Service) ToStaticPageOutputWithContext(ctx context.Context) StaticPageOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StaticPageOutput)
}

func (i *Service) ToStaticPagePtrOutput() StaticPagePtrOutput {
	return i.ToStaticPagePtrOutputWithContext(context.Background())
}

func (i *Service) ToStaticPagePtrOutputWithContext(ctx context.Context) StaticPagePtrOutput {
